# ITESO University
# Cuauhtemoc Aguilera
# User Constraint File: constraints_Adders_slow.tcl
...
## SDC FORMAT
set_input_delay -clock [get_clocks $EXTCLK] -add_delay $INPUT_DELAY -name I_DELAY  [get_ports {rst_n rx}]
...
## SDC FORMAT
set_output_delay -clock [get_clocks $EXTCLK] -add_delay $OUTPUT_DELAY -name O_DELAY [get_ports {tx}]
...
# set_max_transition
#set_max_transition $MAX_LOAD [current_design]

# Alternative to external_pin_cap
set_load $MAX_LOAD -pin_load [get_ports {tx}]
