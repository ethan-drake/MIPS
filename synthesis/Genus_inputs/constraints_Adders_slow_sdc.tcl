...
## SDC FORMAT
set_input_delay -clock [get_clocks $EXTCLK] -add_delay 200 -name I_DELAY  [get_ports {rst_n rx}]
...
## SDC FORMAT
set_output_delay -clock [get_clocks $EXTCLK] -add_delay 200 -name O_DELAY [get_ports {tx}]
