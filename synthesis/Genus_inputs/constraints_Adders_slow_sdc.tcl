...
## SDC FORMAT
set_input_delay -clock [get_clocks $EXTCLK] -add_delay 200 -name I_DELAY  [get_ports {X Y A B cin nrst}]
...
## SDC FORMAT
set_output_delay -clock [get_clocks $EXTCLK] -add_delay 200 -name O_DELAY [get_ports {SUM sum_struct}]
...
# Genus tested
set_driving_cell -lib_cell BUFX2 [get_ports {X Y A B cin nrst}]
