#################################################################################
#
# Created by Genus(TM) Synthesis Solution 20.11-s111_1 on Thu Nov 09 03:16:23 UTC 2023
#
#################################################################################
...
create_constraint_mode -name CM_risc_v_slow \
    -sdc_files { outputs_Nov09-03:11:57/risc_v_Pad_Frame_opt.CM_risc_v_slow.sdc }
create_constraint_mode -name CM_risc_v_fast \
    -sdc_files { outputs_Nov09-03:11:57/risc_v_Pad_Frame_opt.CM_risc_v_fast.sdc }
