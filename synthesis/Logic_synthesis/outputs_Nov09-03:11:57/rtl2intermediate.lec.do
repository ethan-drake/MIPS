...
# Generated on: Thu Nov 09 03:15:15 UTC 2023 (Thu Nov 09 03:15:15 UTC 2023)
...
set_log_file logs_Nov09-03:11:57/rtl2intermediate.lec.log -replace

usage -auto -elapse

# Comparing intermediate 'fv_map' netlist vs. revised netlist.

set_verification_information fv_map_risc_v_Pad_Frame_intermediatev_db

read_implementation_information fv/risc_v_Pad_Frame -golden fv_map -revised risc_v_Pad_Frame_intermediatev
...
read_design -verilog95   -golden -lastmod -noelab fv/risc_v_Pad_Frame/fv_map.v.gz
elaborate_design -golden -root {risc_v_Pad_Frame}

read_design -verilog95   -revised -lastmod -noelab Netlist/risc_v_Pad_Frame_intermediate.v
elaborate_design -revised -root {risc_v_Pad_Frame}

#add_name_alias fv/risc_v_Pad_Frame/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/risc_v_Pad_Frame/risc_v_Pad_Frame_intermediatev.singlebit.original_name.alias.json.gz -revised
...
read_implementation_information fv/risc_v_Pad_Frame -revised fv_map
...
elaborate_design -golden -root {risc_v_Pad_Frame} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/risc_v_Pad_Frame/fv_map.v.gz
elaborate_design -revised -root {risc_v_Pad_Frame}
...
#add_name_alias fv/risc_v_Pad_Frame/fv_map.singlebit.original_name.alias.json.gz -revised
#set_mapping_method -alias -revised
#add_renaming_rule r1alias _reg((\\\[%w\\\])*(/U\\\$%d)*)$ @1 -type dff dlat -both
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Nov09-03:11:57/rtl2intermediate.lec.log
}
