#################################################################################
#
# Created by Genus(TM) Synthesis Solution 20.11-s111_1 on Wed Nov 08 02:32:10 UTC 2023
#
#################################################################################
...
create_constraint_mode -name CM_risc_v_slow \
    -sdc_files { outputs_Nov08-02:26:27/risc_v_Pad_Frame_opt.CM_risc_v_slow.sdc }
create_constraint_mode -name CM_risc_v_fast \
    -sdc_files { outputs_Nov08-02:26:27/risc_v_Pad_Frame_opt.CM_risc_v_fast.sdc }
