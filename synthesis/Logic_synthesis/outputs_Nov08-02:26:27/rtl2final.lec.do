...
# Generated on: Wed Nov 08 02:32:16 UTC 2023 (Wed Nov 08 02:32:16 UTC 2023)
...
set_log_file logs_Nov08-02:26:27/rtl2final.lec.log -replace

usage -auto -elapse

# Comparing intermediate 'fv_map' netlist vs. revised netlist.

set_verification_information fv_map_risc_v_Pad_Frame_optv_db

read_implementation_information fv/risc_v_Pad_Frame -golden fv_map -revised risc_v_Pad_Frame_optv
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Nov08-02:26:27/rtl2final.lec.log
}
