...
################################################################################
source outputs_Nov03-01:21:31/risc_v_top_opt.genus_init.tcl
read_metric -id current outputs_Nov03-01:21:31/risc_v_top_opt.metrics.json

phys::read_script outputs_Nov03-01:21:31/risc_v_top_opt.g
...
unset _slk_
# multi-mode slack
if {"[string_representation [::legacy::get_attribute slack_by_mode design:risc_v_top]]" != "{{mode:risc_v_top/view_risc_v_slow 4082.0} {mode:risc_v_top/view_risc_v_fast 126.7}}"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack_by_mode: {{mode:risc_v_top/view_risc_v_slow 4082.0} {mode:risc_v_top/view_risc_v_fast 126.7}}  current slack_by_mode: [string_representation [::legacy::get_attribute slack_by_mode design:risc_v_top]]"
}
# tns
