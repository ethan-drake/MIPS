#################################################################################
#
# Created by Genus(TM) Synthesis Solution 20.11-s111_1 on Tue Nov 28 04:55:17 UTC 2023
#
#################################################################################
...
create_constraint_mode -name CM_risc_v_slow \
    -sdc_files { outputs_Nov28-04:48:31/risc_v_Pad_Frame_opt.CM_risc_v_slow.sdc }
create_constraint_mode -name CM_risc_v_fast \
    -sdc_files { outputs_Nov28-04:48:31/risc_v_Pad_Frame_opt.CM_risc_v_fast.sdc }
...
set_analysis_view -setup { view_risc_v_slow view_risc_v_fast } \
                  -hold { view_risc_v_fast view_risc_v_slow }
