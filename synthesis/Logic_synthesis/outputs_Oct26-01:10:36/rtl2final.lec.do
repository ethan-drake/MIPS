...
set_log_file logs_Oct26-01:10:36/rtl2final_bug.lec.log -replace

usage -auto -elapse

# Comparing intermediate 'fv_map' netlist vs. revised netlist.

set_verification_information fv_map_Adders_opt_BUGv_db

read_implementation_information fv/risc_v_top -golden fv_map -revised Adders_opt_BUGv
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Oct26-01:10:36/rtl2final_bug.lec.log
}
