...
# Generated on: Thu Oct 26 01:27:54 UTC 2023 (Thu Oct 26 01:27:54 UTC 2023)
...
set_log_file logs_Oct26-01:10:36/intermediate2final_bug.lec.log -replace

usage -auto -elapse

set_verification_information Adders_intermediate_BUGv_Adders_opt_BUGv_db

read_implementation_information fv/risc_v_top -golden Adders_intermediate_BUGv -revised Adders_opt_BUGv
...
read_design -verilog95   -golden -lastmod -noelab Netlist/Adders_intermediate_BUG.v
elaborate_design -golden -root {risc_v_top}

read_design -verilog95   -revised -lastmod -noelab Netlist/Adders_opt_BUG.v
elaborate_design -revised -root {risc_v_top}

#add_name_alias fv/risc_v_top/Adders_intermediate_BUGv.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/risc_v_top/Adders_opt_BUGv.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Oct26-01:10:36/intermediate2final_bug.lec.log
}
