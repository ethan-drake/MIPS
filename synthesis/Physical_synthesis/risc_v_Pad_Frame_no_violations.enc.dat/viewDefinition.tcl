...
create_library_set -name Lib_Set_BC\
   -timing\
    ...
    ${::IMEX::libVar}/mmmc/pads_FF_s1vg.lib]
...
create_constraint_mode -name ConstraintMode_WC\
   -sdc_files\
    [list ${::IMEX::dataVar}/mmmc/modes/ConstraintMode_WC/ConstraintMode_WC.sdc]
create_constraint_mode -name ConstraintMode_BC\
   -sdc_files\
    [list ${::IMEX::dataVar}/mmmc/modes/ConstraintMode_BC/ConstraintMode_BC.sdc]
create_analysis_view -name AnalysisView_BC -constraint_mode ConstraintMode_BC -delay_corner DelayCorner_BC -latency_file ${::IMEX::dataVar}/mmmc/views/AnalysisView_BC/latency.sdc
create_analysis_view -name AnalysisView_WC -constraint_mode ConstraintMode_WC -delay_corner DelayCorner_WC -latency_file ${::IMEX::dataVar}/mmmc/views/AnalysisView_WC/latency.sdc
